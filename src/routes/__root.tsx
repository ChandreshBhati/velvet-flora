  ...
  head: () => ({
    meta: [
      ...
      { title: "Velvet Flora" },
      {
        name: "description",
        content:
          "Handcrafted pipe-cleaner flowers that never fade. Gifts, decor, and special moments by Velvet Flora.",
      },
      { name: "author", content: "Velvet Flora" },
      { property: "og:title", content: "Velvet Flora" },
      {
      ...
      { name: "twitter:site", content: "@VelvetFlora" },
    ],
    links: [
